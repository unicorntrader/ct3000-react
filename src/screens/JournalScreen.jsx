                ...
                return (
                  <React.Fragment key={trade.id}>
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-6 py-4 text-sm font-semibold text-gray-900 whitespace-nowrap max-w-[10rem]" title={trade.symbol}>
                        <span className="inline-flex items-center gap-1.5">
                          <span className="truncate">{fmtSymbol(trade)}</span>
